      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div className="max-w-4xl mx-auto">
          <Job
            ...
            logoSrc={jaggaerLogo}
            responsibilities={[
              "Built multi-agent orchestration with LangSmith and LangGraph for the procurement domain, routing user requests across agent nodes and integrating GitHub CI/CD for pipeline automation",
              "Led multi-agent orchestration for ticketing tool workflows combining deterministic Python pipelines (order status, cancel-order, unified leadership/CSR report bundles) with Claude Agent SDK triage, including deduplication state, safety escalation rules, dry-run modes, and pytest coverage for pipeline gates",
              "Implemented a RAG pipeline where agents retrieve and rank document chunks from Google Cloud Storage (with Pinecone experiments), reply to users via orchestrated nodes, and are evaluated with RAGAs and DeepEval on Faithfulness, Answer Relevancy, and Contextual Precision/Recall",
              "Built a production MCP tool layer for a 3PL logistics client, connecting a ticketing tool, order databases, SharePoint reporting, and Microsoft Graph notifications, deployed on Azure Kubernetes with Helm/ArgoCD and CI-gated releases",
